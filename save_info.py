...
if __name__ == "__main__":
    ...
    try:
        ...
        for i,s in enumerate(sav):
            ...
            print("    * Game Time (HHH:MM:SS.MMM): %s:%s:%s.%s" % (str(d['gametime'][0]).zfill(3), str(d['gametime'][1]).zfill(2), str(d['gametime'][2]).zfill(2), str(d['gametime'][3]/30.).lstrip('0.')[:3].ljust(3,'0')))
